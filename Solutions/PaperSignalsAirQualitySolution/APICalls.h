...
public:
  ...
  String CustomIntentType = "Pollution";
  ...
  //TASK A: Variables to keep track of when last AQI was fetched. 
  unsigned long lastAQICall = 0;
  unsigned long timeBetweenAQICalls = 120000; // set to 2 minutes, or 120 000 ms. 
public:
  ...
  void AirQuality(String Location);
  String GetAirQuality(String JSONData);
